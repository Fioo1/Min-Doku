...
export function GameProvider({ children }) {
  ...
  const recordWin = ({ coins, xp, seconds, difficulty, mistakes, hintsUsed, daily }) => {
    ...
    saveGame({ difficulty, seconds, mistakes, hints_used: hintsUsed, daily, challenge_date: daily ? new Date().toISOString().slice(0, 10) : null, completed: true }).catch(console.error)
  }
